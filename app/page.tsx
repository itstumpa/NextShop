...
export default function HomePage() {
  ...
  const getProductImageUrl = (thumbnail?: string | null): string | null => {
    // Handle null, undefined, empty string, or placeholder values
    if (
      !thumbnail ||
      thumbnail === "string" ||
      thumbnail.trim() === "" ||
    ...
    if (uuidRegex.test(thumbnail)) {
      // Adjust this URL to match your backend image serving endpoint
      return `${
    ...
    if (
      ...
      (thumbnail.includes(".jpg") ||
        ...
        thumbnail.includes(".webp"))
    ) {
      return `/images/${thumbnail}`;
    }

    // If it's just a filename without extension, assume it's an ID
    if (thumbnail.length > 0 && !thumbnail.includes("/")) {
      return `${
        process.env.NEXT_PUBLIC_API_URL || "http://localhost:3000"
      }/api/images/${thumbnail}`;
    }
  ...
  const features = [
    ...
    },
    {
      ...
      title: "Easy Returns",
      description:
        "30-day hassle-free returns. Not satisfied? Get your money back.",
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Check the structure of thumbnail URLs
        if (productsData.data && productsData.data.length > 0) {
          console.log(
            "First product thumbnail:",
            productsData.data[0].thumbnail
          );
        }
        ...
        setBestSellers(
          allProducts.filter((p) => parseFloat(p.rating) >= 4.0).slice(0, 6)
        );
      } catch (err) {
      ...
      <section className="relative bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 text-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32">
          <div className="grid lg:grid-cols-3 gap-8 items-center">
            {/* Text Content */}
            <div className="text-center lg:text-left col-span-2 z-10">
              <div className="inline-block mb-4 px-4 py-2 bg-yellow-400/20 border border-yellow-300/30 rounded-full">
              ...
              <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight">
                Discover Amazing
                <span className="block text-yellow-300">Electronics</span>
              </h1>

              <p className="text-xl md:text-2xl mb-8 text-blue-100 max-w-2xl mx-auto lg:mx-0">
                Shop the latest tech trends with unbeatable prices and premium
                quality guaranteed electronics products
              </p>
              ...
              <div className="mt-12 flex flex-wrap gap-6 justify-center lg:justify-start text-sm">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-blue-100">30-Day Returns</span>
                </div>
              </div>
            </div>
            ...
            <div className="relative z-10">
              <div className="relative col-span-1 w-full max-w-md mx-auto">
                {/* Decorative circles */}
                <div className="absolute w-96 h-96 bg-white/10 rounded-full -top-10 -right-10 blur-2xl animate-pulse"></div>
                <div className="absolute w-72 h-72 bg-white/20 rounded-full top-10 right-10 blur-xl"></div>
                ...
                <div className="relative bg-white/10 backdrop-blur-sm rounded-3xl p-8 border border-white/20 shadow-2xl">
                  ...
                  <div className="relative aspect-square bg-gradient-to-br from-gray-100 to-gray-200 rounded-2xl overflow-hidden shadow-xl">
                    <div className="absolute inset-0 flex items-center justify-center">
                      {/* High-quality electronics product illustration */}
                      <svg
                ...
                {/* Floating elements */}
                <div className="absolute -top-6 -left-6 bg-yellow-400 text-blue-900 px-4 py-2 rounded-xl font-bold shadow-lg animate-bounce">
                  Hot Deal! 🔥
                </div>
                <div className="absolute -bottom-6 -right-6 bg-white text-blue-600 px-4 py-2 rounded-xl font-semibold shadow-lg">
                  ⚡ Fast Delivery
                </div>
              </div>
            </div>
                  ...
                  return (
                    ...
                    >
                      <div className="bg-white rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden border border-gray-100 hover:border-blue-200">
                        ...
                        <div className="p-4">
                          <Link href={`/products/${product.productId}`}>
                            <h3 className="font-semibold text-gray-900 mb-2 line-clamp-1 hover:text-blue-600 transition-colors cursor-pointer">
                              {product.productName}
                            </h3>
                          </Link>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 relative">
            ...
            <div className="text-center mb-16">
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
                Why Choose <span className="text-blue-600">NextShop?</span>
              </h2>
              <p className="text-gray-600 text-lg md:text-xl max-w-2xl mx-auto">
                We're committed to providing you with the best shopping
                experience with premium quality and service
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {features.map((feature, index) => (
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-gradient-to-br opacity-0 group-hover:opacity-5 transition-opacity duration-300 rounded-2xl from-blue-500 to-purple-500"></div>

                  {/* Icon */}
                  <div
                    className={`w-16 h-16 bg-gradient-to-br ${feature.gradient} text-white rounded-xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg`}
                  >
                    {feature.icon}
                  </div>
                  ...
                  <div className="absolute top-0 right-0 w-16 h-16 bg-gradient-to-br from-blue-500/10 to-transparent rounded-bl-3xl rounded-tr-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                </div>
              ))}
            </div>
          ...
          <div className="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-3xl text-white p-8 md:p-12 relative overflow-hidden">
            ...
            <div className="relative text-center max-w-3xl mx-auto">
              ...
              <p className="text-blue-100 text-lg mb-8">
                ...
                and insider tips. Join over 50,000 happy subscribers!
              </p>
          ...
          <div className="border-t border-gray-800 mt-12 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              <div className="text-gray-400 text-center md:text-left">
                <p>
                  &copy; 2026 NextShop. All rights reserved. Built with ❤️ using
